...
let sip1_toplam = ((siparis_1.urunler[0].urun_fiyat + siparis_1.urunler[1].urun_fiyat) * 1.18);
let sip2_toplam = (siparis_2.urunler[0].urun_fiyat * 1.18);
console.log(sip1_toplam);
console.log(sip2_toplam);
let sip_toplam = ((sip1_toplam)+(sip2_toplam));
console.log(sip_toplam);
